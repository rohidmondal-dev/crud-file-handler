...
const ProfileCard = () => {
	return (
		<>
			<Card className="py-0">
				<CardHeader className="h-32 w-full rounded-t-xl bg-[url(/cover.jpg)] bg-cover bg-center bg-no-repeat"></CardHeader>
				...
				<CardFooter className="grid w-full grid-cols-2 gap-3 pb-4">
